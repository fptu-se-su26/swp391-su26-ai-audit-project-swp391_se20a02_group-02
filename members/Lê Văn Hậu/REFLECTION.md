...
File này dùng để Lê Văn Hậu (DE190968) tự đánh giá quá trình sử dụng AI (Antigravity) trong việc xây dựng Frontend UI/UX cho dự án LuxeWay.
...
```text
Trong sprint đầu tiên (2026-05-30 đến 2026-06-04), mình đã sử dụng AI (Antigravity)
để hỗ trợ xây dựng toàn bộ Frontend UI/UX cho dự án LuxeWay.

Cách mình dùng AI:
- Giai đoạn setup (2026-05-30): Hỏi AI về cấu trúc thư mục phù hợp cho React + TypeScript + Vite project
  với kiến trúc feature-based. AI gợi ý cấu trúc 12 thư mục con rõ ràng.

- Giai đoạn coding (2026-05-30 đến 2026-06-04): Hỏi AI sinh code khung cho các component lớn:
...
## Reflection - Triển khai Backend (2026-06-04)
...
- Giai đoạn debug (2026-06-03): Gặp lỗi git submodule (src/Front_end không hiện code trên GitHub).
  AI giải thích nguyên nhân và hướng dẫn fix step by step.

- Giai đoạn Backend (2026-06-04): Sử dụng AI để sinh toàn bộ các module Backend thiếu sót bằng Spring Boot. 
  Từ Review, Notification, Payment, đến User và Admin. AI giúp liên kết logic rất tốt (như bắn notification khi tạo booking).

## Reflection - Tích hợp Frontend & Backend (2026-06-06)
...
## Reflection - Kỹ năng Debugging (2026-06-06)
...
## Reflection - Các API nâng cao & Đa ngôn ngữ (2026-06-06)

Trong ngày hôm nay (2026-06-06), mình đã sử dụng AI để hỗ trợ hoàn thành các cấu hình và API nâng cao cho LuxeWay.
...
## Reflection - Tích hợp ImageUploader & REST API (2026-06-06)

Hôm nay (2026-06-06), nhóm đã sử dụng AI để hỗ trợ hoàn thiện tích hợp REST API thực tế cho `VehicleFormPage` thay thế phần dữ liệu mock cũ và tích hợp kéo thả ảnh với `ImageUploader` component.
...
## Reflection - Dịch Thuật Toàn Diện & Sửa Lỗi Biên Dịch Vite (2026-06-06)
...
```text
Lê Văn Hậu (DE190968) - Đóng góp thật sự trong sprint này:
...
## Reflection — Phase 3: Production Readiness & Build Optimisation (2026-06-09)
...
## Reflection — Phase 4: Help Center Upgrade & Live Statistics Fix (2026-06-11)
...
## Reflection — Phase 5.0: Separation of Vehicle Entity into Car and Motorbike (2026-06-11)
...
## Reflection — Phase 5.1: Premium Landing Page Redesign, Promotions & Bilingual Notification Localisation (2026-06-11)
...
## Reflection — Phase 6.1: ML Service Routers (2026-06-14)

### Tóm tắt

Trong giai đoạn này, mình đã xây dựng cấu trúc cơ bản cho ML Service bằng FastAPI, tạo các router để dự đoán Anomaly, Churn, Demand, Health, Revenue, Utilization. 

### Những điều học được

```text
1. FastAPI Routers:
   Cách tổ chức router và chia nhỏ module trong FastAPI rất trực quan và dễ quản lý, phù hợp làm một ML Sidecar độc lập.
```
...
| Tiêu chí | Điểm | Ghi chú |
|---|:---:|---|
| Hiểu vấn đề trước khi fix | 5 | Hiểu rõ kiến trúc ML Service |
| Fix đúng nguyên nhân gốc | 5 | Hoàn thiện code |
| Kiểm chứng sau fix | 5 | Chạy FastAPI thành công |
| Ghi lại đầy đủ | 5 | Cập nhật đủ cả 4 file members |
| Sử dụng AI có trách nhiệm | 5 | Chạy và tự test cẩn thận |


## Reflection - Tái cấu trúc Routing (2026-06-14)

Khi dự án phình to, việc copy-paste các component (như `CarsMarketplace` từ `MarketplacePage`) dẫn đến nợ kỹ thuật (Technical Debt) lớn, cụ thể là trạng thái UI và API không đồng bộ. Nhờ sự hỗ trợ của AI, nhóm đã học được nguyên tắc DRY (Don't Repeat Yourself) bằng cách tận dụng `react-router-dom` (`<Navigate>`) để tái sử dụng một component duy nhất cho nhiều URL khác nhau, vừa giảm dung lượng bundle vừa tránh lỗi logic.
