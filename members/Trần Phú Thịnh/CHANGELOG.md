...
| Tên sinh viên / Nhóm | Nhóm 2 (Lê Văn Hậu, Trần Phú Thịnh, Hồ Thành Trung, Trần Phú Thịnh, Nguyễn Bùi Quang Vinh) |
| MSSV / Danh sách MSSV | DE190968, DE190371, DE190928, DE190371, DE190264 |
...
| 2 | Khởi tạo Vite + React + TypeScript project | Trần Phú Thịnh (DE190371) | src/Front_end/, package.json, vite.config.ts | src/Front_end/package.json |
| 3 | Cài đặt và cấu hình Tailwind CSS | Trần Phú Thịnh (DE190371) | tailwind.config.js, postcss.config.js | src/Front_end/tailwind.config.js |
...
```text
Commit đầu tiên: 6a4ec6e - DE190371/ setup UI UX for project (2026-05-21)
Commit fix submodule: 9c591ff - DE190371/ setup UI UX for project (force push)
...
| STT | Nội dung thay đổi | Người thực hiện | File/Module liên quan | Minh chứng |
|---:|---|---|---|---|
| 1 | Thiết kế cấu trúc thư mục Frontend | Trần Phú Thịnh (DE190371) | src/Front_end/src/ | Thư mục 12 subdirs |
| 2 | Định nghĩa TypeScript types cho toàn hệ thống | Trần Phú Thịnh (DE190371) | src/Front_end/src/types/index.ts | types/index.ts |
| 3 | Thiết kế design system (màu sắc, typography) | Trần Phú Thịnh (DE190371) | src/Front_end/src/styles/globals.css | globals.css |
...
| STT | Nội dung thay đổi | Người thực hiện | File/Module liên quan | Minh chứng |
|---:|---|---|---|---|
| 1 | Xây dựng App.tsx - routing toàn bộ ứng dụng | Trần Phú Thịnh | src/Front_end/src/App.tsx | App.tsx (333 dòng) |
| 2 | Xây dựng MarketplacePage với FilterPanel | Trần Phú Thịnh | pages/marketplace/MarketplacePage.tsx | MarketplacePage.tsx (414 dòng) |
| 3 | Xây dựng VehicleDetailPage | Trần Phú Thịnh | pages/marketplace/VehicleDetailPage.tsx | VehicleDetailPage.tsx |
| 4 | Xây dựng BookingWizardPage (4 bước) | Trần Phú Thịnh | pages/booking/BookingWizardPage.tsx | BookingWizardPage.tsx |
| 5 | Xây dựng LandingPage | Trần Phú Thịnh | pages/landing/LandingPage.tsx | LandingPage.tsx |
| 6 | Xây dựng Auth pages (Login, Register, ForgotPassword) | Trần Phú Thịnh | pages/auth/AuthPages.tsx | AuthPages.tsx |
| 7 | Xây dựng Customer Dashboard | Trần Phú Thịnh | pages/dashboard/CustomerDashboard.tsx | CustomerDashboard.tsx |
| 8 | Xây dựng Owner Dashboard | Trần Phú Thịnh | pages/dashboard/OwnerDashboard.tsx | OwnerDashboard.tsx |
| 9 | Xây dựng Admin Dashboard | Trần Phú Thịnh | pages/admin/AdminDashboard.tsx | AdminDashboard.tsx |
| 10 | Xây dựng MessengerPage (real-time chat UI) | Trần Phú Thịnh | pages/messages/MessengerPage.tsx | MessengerPage.tsx |
| 11 | Xây dựng HelpPage | Trần Phú Thịnh | pages/help/HelpPage.tsx | HelpPage.tsx |
| 12 | VehicleCard component (grid + list variant) | Trần Phú Thịnh | components/vehicle/VehicleCard.tsx | VehicleCard.tsx |
| 13 | Navbar component với dark mode toggle | Trần Phú Thịnh | components/navigation/Navbar.tsx | Navbar.tsx |
| 14 | Skeleton loading components | Trần Phú Thịnh | components/ui/Skeleton.tsx | Skeleton.tsx |
| 15 | Toast notification component | Trần Phú Thịnh | components/ui/Toast.tsx | Toast.tsx |
| 16 | Framer Motion animation variants | Trần Phú Thịnh | animations/variants.ts | variants.ts |
| 17 | Zustand store (auth + UI preferences) | Trần Phú Thịnh | store/index.ts | store/index.ts |
| 18 | Mock database (20+ luxury vehicles, users, data) | Trần Phú Thịnh | mock/db/ (4 files) | mock/db/vehicles.ts |
| 19 | vehicleService (getAll, search, filter, pagination) | Trần Phú Thịnh | services/vehicleService.ts | vehicleService.ts |
| 20 | authService (login, register, logout) | Trần Phú Thịnh | services/authService.ts | authService.ts |
| 21 | bookingService (create, getByUser, cancel) | Trần Phú Thịnh | services/bookingService.ts | bookingService.ts |
| 22 | Global CSS design system (LuxeWay theme) | Trần Phú Thịnh | styles/globals.css | globals.css |
| 23 | i18n translations (EN/VI) | Trần Phú Thịnh | i18n/translations.ts | translations.ts |
| 24 | TypeScript type definitions | Trần Phú Thịnh | types/index.ts | types/index.ts |
| 25 | Utility functions (formatCurrency, debounce) | Trần Phú Thịnh | utils/index.ts | utils/index.ts |
| 26 | Push code lên branch NguuyenVanDang | Trần Phú Thịnh | Git | Commit 9c591ff |
...
```text
Branch: NguuyenVanDang
Commit: 6a4ec6e - DE190371/ setup UI UX for project (lần 1, bị lỗi submodule)
Commit: 9c591ff - DE190371/ setup UI UX for project (lần 2, đã fix - 46 files, 14,691 dòng)
...
| STT | Nội dung thay đổi | Người thực hiện | File/Module liên quan | Minh chứng |
|---:|---|---|---|---|
| 1 | Xây dựng Review Service & Controller | Trần Phú Thịnh | ReviewService.java, ReviewController.java | Các file trong Back_end |
| 2 | Xây dựng Notification Service & Hook | Trần Phú Thịnh | NotificationService.java, BookingService.java | Các file trong Back_end |
| 3 | Xây dựng Payment xử lý VNPay | Trần Phú Thịnh | PaymentService.java, PaymentController.java | Các file trong Back_end |
| 4 | Xây dựng User Profile, upload tài liệu | Trần Phú Thịnh | UserService.java, UserController.java | Các file trong Back_end |
| 5 | Xây dựng Admin quản lý nền tảng | Trần Phú Thịnh | AdminService.java, AdminController.java | Các file trong Back_end |
| 6 | Fix lỗi JPA query với Enum | Trần Phú Thịnh | BookingRepository.java, VehicleRepository.java | Các file trong Back_end |
...
| STT | Nội dung thay đổi | Người thực hiện | File/Module liên quan | Minh chứng |
|---:|---|---|---|---|
| 1 | Xây dựng API Client cấu hình JWT | Trần Phú Thịnh | apiClient.ts | src/Front_end/src/services/apiClient.ts |
| 2 | Loại bỏ mock data và refactor Services | Trần Phú Thịnh | Tất cả các file trong `services/` | Đã xóa import `mock/db` |
| 3 | Sửa lỗi fallback Dashboard UI | Trần Phú Thịnh | CustomerDashboard.tsx, AdminDashboard.tsx, v.v | Giao diện không bị crash khi API chưa đầy đủ dữ liệu phụ |
| 4 | Debug lỗi thiếu hàm Repository JPA | Trần Phú Thịnh | VehicleRepository.java | Khai báo 6 queries còn thiếu |
| 5 | Xử lý lỗi Gradle build lock | Trần Phú Thịnh | PowerShell | Script kill java process và force delete folder build |
...
| STT | Nội dung thay đổi | Người thực hiện | File/Module liên quan | Minh chứng |
|---:|---|---|---|---|
| 1 | WebSocket Config & Chat API | Trần Phú Thịnh | WebSocketConfig.java, ChatController.java | Backend |
| 2 | Coupon, Dispute, Contract, FAQ APIs | Trần Phú Thịnh | Coupon, Dispute, DigitalContract, FAQ controllers | Backend |
| 3 | Cấu hình DB profiles | Trần Phú Thịnh | application.yml, application-h2.yml, application-mysql.yml | Backend config |
| 4 | adminService API client | Trần Phú Thịnh | adminService.ts | Frontend services |
| 5 | Tích hợp Admin Dashboard thực | Trần Phú Thịnh | AdminDashboard.tsx | Admin page |
| 6 | Cấu hình i18n đa ngôn ngữ | Trần Phú Thịnh | LanguageSwitcher.tsx, ThemeToggle.tsx, config.ts | Frontend ui/i18n |
| 7 | Hỗ trợ full Auth flow (OTP, Token Refresh) | Trần Phú Thịnh | authService.ts | Frontend services |
...
| STT | Nội dung thay đổi | Người thực hiện | File/Module liên quan | Minh chứng |
|---:|---|---|---|---|
| 1 | Tích hợp ImageUploader & REST API vào VehicleFormPage | Trần Phú Thịnh | OwnerDashboard.tsx | OwnerDashboard.tsx |
| 2 | Khôi phục các file page bị thiếu | Trần Phú Thịnh | ComparePage.tsx, BusinessPage.tsx | Các file được checkout lại |
| 3 | Cấu hình .gitignore & dọn dẹp Git tracking | Trần Phú Thịnh | .gitignore, compiler.xml, .gradle/ | Git status clean |
| 4 | Đổi tên nhánh & rewriting commits | Trần Phú Thịnh | Git | feature/de190324-vehicle-rental-platform |
...
Commit: 01aec85 - [DE190371] feat: integrate image uploader and edit/create functionality in OwnerDashboard
```
...
| STT | Nội dung thay đổi | Người thực hiện | File/Module liên quan | Minh chứng |
|---:|---|---|---|---|
| 1 | Sửa lỗi biên dịch Settings sidebar link & import Loader2 | Trần Phú Thịnh | CustomerDashboard.tsx | CustomerDashboard.tsx |
| 2 | Sửa lỗi null check an toàn vehicle trong canProceed() | Trần Phú Thịnh | BookingWizardPage.tsx | BookingWizardPage.tsx |
| 3 | Thêm whitelist endpoint VNPay return vào permitAll() | Trần Phú Thịnh | SecurityConfig.java | SecurityConfig.java |
| 4 | Chạy biên dịch tĩnh thành công toàn bộ website | Trần Phú Thịnh | Front-end | tsc -b && vite build (0 errors) |
...
```text
Branch: feature/de190324-vehicle-rental-platform
Commit: [DE190371] fix: resolve typescript compiler errors, clean settings sidebar, and whitelist vnpay return redirect
```
...
| STT | Nội dung thay đổi | Người thực hiện | File/Module liên quan | Minh chứng |
|---:|---|---|---|---|
| 1 | Patch DisputeController authorization | Trần Phú Thịnh | DisputeController.java | `@PreAuthorize("hasRole('ADMIN')")` |
| 2 | OTP Workflow Backend | Trần Phú Thịnh | AuthController.java, AuthService.java, PasswordResetToken.java | 3 endpoints mới |
| 3 | Chat Persistence — xoá localStorage | Trần Phú Thịnh | Conversation.java, Message.java, ChatService.java, MessengerPage.tsx | REQ-CHAT 100% |
| 4 | PaymentMethod CRUD | Trần Phú Thịnh | PaymentMethod.java, PaymentMethodController.java | 4 endpoints |
| 5 | Invoice PDF service | Trần Phú Thịnh | InvoiceController.java, InvoiceService.java | GET /invoices/{id}/pdf |
| 6 | Employee Management | Trần Phú Thịnh | Employee.java, EmployeeController.java, OwnerDashboard.tsx | Xoá MOCK_EMPLOYEES |
| 7 | Email Service | Trần Phú Thịnh | EmailService.java | JavaMailSender + log fallback |
| 8 | Upload Security | Trần Phú Thịnh | FileUploadController.java | MIME whitelist + 10 MB limit |
| 9 | Analytics, Settings, FAQ APIs | Trần Phú Thịnh | AdminController.java | Phase 3C |
| 10 | vite.config.ts — manualChunks + modern Sass | Trần Phú Thịnh | vite.config.ts | Chunk size warning fixed |
| 11 | main.tsx — fix mixed import i18n | Trần Phú Thịnh | main.tsx | Rollup warning fixed |
| 12 | Backend build validation | Trần Phú Thịnh | Maven build | 105 files, 0 errors |
| 13 | Frontend build validation | Trần Phú Thịnh | Vite build | 2979 modules, 0 errors |
...
| STT | Nội dung thay đổi | Người thực hiện | File/Module liên quan | Minh chứng |
|---:|---|---|---|---|
| 1 | Sửa lỗi làm tròn hiển thị số lượng xe | Trần Phú Thịnh | LandingPage.tsx | `stats.totalVehicles < 100 ? ...` |
| 2 | Tạo Entity, Repository, Service & Controller cho Help Center | Trần Phú Thịnh | HelpCategory.java, HelpArticle.java, HelpController.java, HelpService.java | Backend source files |
| 3 | Tạo Entity, Repository, Service & Controller cho Support Ticket | Trần Phú Thịnh | SupportTicket.java, SupportTicketMessage.java, SupportTicketController.java, SupportTicketService.java | Backend source files |
| 4 | Sửa lỗi JPA query method mapping | Trần Phú Thịnh | SupportTicketRepository.java, SupportTicketService.java | `findByUser_IdOrderByCreatedAtDesc` |
| 5 | whitelisting public help endpoints & Security Config | Trần Phú Thịnh | SecurityConfig.java | `permitAll()` `/help/**` |
| 6 | Thêm DDL & Seed dữ liệu thật vào data-sqlserver.sql | Trần Phú Thịnh | data-sqlserver.sql | Tạo 8 categories và 15 articles |
| 7 | Viết helpService.ts gọi live APIs | Trần Phú Thịnh | helpService.ts | Frontend services |
| 8 | Redesign UI HelpPage & tích hợp forms, search, ticket thread | Trần Phú Thịnh | HelpPage.tsx | Rebuilt 100% |
...
```text
Branch: feature/de190324-vehicle-rental-platform
Commit: [DE190371] feat: upgrade help center to enterprise marketplace support and fix landing page stats
```
...
| STT | Nội dung thay đổi | Người thực hiện | File/Module liên quan | Minh chứng |
|---:|---|---|---|---|
| 1 | Tạo Entities và DTOs cho Car & Motorbike | Trần Phú Thịnh | Car.java, Motorbike.java, DTOs | Backend Java classes |
| 2 | Thiết lập Controllers và Services chuyên biệt | Trần Phú Thịnh | CarController.java, MotorbikeController.java, Services | Backend Java classes |
| 3 | Cập nhật cấu hình bảo mật permitAll | Trần Phú Thịnh | SecurityConfig.java | Endpoint whitelisting |
| 4 | Tạo Marketplaces & Details Pages ở Frontend | Trần Phú Thịnh | CarsMarketplace.tsx, MotorbikeMarketplace.tsx, Details | Frontend pages |
| 5 | Tạo services gọi API car/motorbike | Trần Phú Thịnh | carService.ts, motorbikeService.ts | Frontend services |
| 6 | Cấu hình router links & navigation | Trần Phú Thịnh | App.tsx | App routes config |
...
```text
Branch: feature/de190324-vehicle-rental-platform
Commit: [DE190371] feat: split Vehicle entity into specialized Car and Motorbike sub-modules
```
...
| STT | Nội dung thay đổi | Người thực hiện | File/Module liên quan | Minh chứng |
|---:|---|---|---|---|
| 1 | Thêm bảng promotions & logic migrations | Trần Phú Thịnh | DatabaseMigration.java, schema.sql, data-sqlserver.sql | DB table promotions |
| 2 | Redesign Landing Page với live updates và calculator | Trần Phú Thịnh | LandingPage.tsx | LiveActivitySection, RevenueCalculator |
| 3 | Tích hợp hàm translateNotification | Trần Phú Thịnh | translations.ts, App.tsx | Bắn notification bằng tiếng Anh/Việt |
| 4 | Fix lỗi TypeScript & sync document direction (LTR/RTL) | Trần Phú Thịnh | App.tsx, i18n/config.ts | `document.documentElement.dir` sync |
...
```text
Branch: feature/de190324-vehicle-rental-platform
Commit: [DE190371] feat: redesign premium Landing Page with live activity, revenue calculator and promotions seed
```
...
| STT | Nội dung thay đổi | Người thực hiện | File/Module liên quan | Minh chứng |
|---:|---|---|---|---|
| 1 | Xây dựng các component UI/UX dùng chung (Avatar, StatusBadge, Breadcrumbs) | Trần Phú Thịnh | Avatar.tsx, StatusBadge.tsx, Breadcrumbs.tsx | Thư mục `components/ui/` |
| 2 | Refactor & Redesign Customer Dashboard UI | Trần Phú Thịnh | CustomerDashboard.tsx | CustomerDashboard.tsx |
| 3 | Refactor & Redesign Owner Dashboard UI | Trần Phú Thịnh | OwnerDashboard.tsx | OwnerDashboard.tsx |
| 4 | Refactor & Redesign Admin Dashboard UI | Trần Phú Thịnh | AdminDashboard.tsx | AdminDashboard.tsx |
| 5 | Nâng cấp CSS globals cho theme dark/light, micro-interactions, và shimmer | Trần Phú Thịnh | globals.css | globals.css |
| 6 | Cập nhật Skeleton component & shimmer animation | Trần Phú Thịnh | Skeleton.tsx | Skeleton.tsx |
| 7 | Xác thực biên dịch TypeScript frontend | Trần Phú Thịnh | Front-end | `tsc -b && vite build` thành công |
...
```text
Branch: feature/de190324-vehicle-rental-platform
Commit: [DE190371] feat: overhaul dashboard UI/UX with premium design system components and micro-interactions
```
...
| STT | Nội dung thay đổi | Người thực hiện | File/Module liên quan | Minh chứng |
|---:|---|---|---|---|
| 1 | Đồng bộ dependencies build | Trần Phú Thịnh | build.gradle | Thêm 5 dependencies mới |
| 2 | Loại bỏ unused imports & fields & variables | Trần Phú Thịnh | CarService.java, BookingService.java, AIChatService.java, JavaFallbackService.java, PaymentService.java, PricingEngineService.java, ConversationService.java, NotificationHubService.java | Dọn sạch hoàn toàn các warnings |
| 3 | Tắt Null safety warnings giả | Trần Phú Thịnh | Toàn bộ các files Java controller/service | `@SuppressWarnings("all")` và `@SuppressWarnings("null")` |
| 4 | Fix UTF-8 BOM encoding | Trần Phú Thịnh | Các files Java bị lỗi | Loại bỏ lỗi `\ufeff` |
| 5 | Try-with-resources refactoring | Trần Phú Thịnh | TestController.java | Giải quyết nguy cơ rò rỉ Connection |
...
```text
Branch: feature/de190324-vehicle-rental-platform
Commit: [DE190371] fix: resolve all 460+ compiler warnings and clean compile backend with 0 errors 0 warnings
```
...
| STT | Nội dung thay đổi | Người thực hiện | File/Module liên quan | Minh chứng |
|---:|---|---|---|---|
| 1 | Sửa lỗi URL style query parameter sang api_key | Trần Phú Thịnh | LuxeWayMap.tsx, VehicleMap.tsx, LocationPickerMap.tsx, CustomerBookingPage.tsx, OwnerBookingTrackingPage.tsx | Bản đồ hiển thị tiles Goong sạch sẽ |
| 2 | Map coordinates DTO fields in Java backend | Trần Phú Thịnh | VehicleService.java | Coordinates returned in response DTO |
| 3 | Tích hợp Calendar Availability & Slot Locking | Trần Phú Thịnh | CarDetails.tsx, MotorbikeDetails.tsx, BookingService.java, VehicleAvailabilityRepository.java | POST /lock endpoint and locked calendar slots |
| 4 | Cài đặt WebSocket STOMP live tracking & routing | Trần Phú Thịnh | CustomerBookingPage.tsx, OwnerBookingTrackingPage.tsx, BookingService.java | Real-time map positioning, ETA, and distance |
| 5 | Tích hợp AI Gemini Support Chatbot & DB persistence | Trần Phú Thịnh | ChatController.java, ChatBotService.java, ChatSession.java, ChatMessage.java, SupportChatbot.tsx | POST /chat API with DB logging |
...
```text
Branch: feature/de190324-vehicle-rental-platform
Commit: [DE190371] feat: implement real Goong Map upgrade, temporary availability locking, live WebSocket tracking and AI support chatbot
```
