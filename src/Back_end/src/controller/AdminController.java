...
public class AdminController {
    ...
    @Operation(summary = "List owner applications")
    ...
    @PostMapping("/owner-applications/{id}/approve")
    @Operation(summary = "Approve owner application")
    public ResponseEntity<ApiResponse<com.luxeway.dto.ownerapplication.OwnerApplicationDTOs.OwnerApplicationResponse>> approveApplication(
            @PathVariable String id,
            @AuthenticationPrincipal User admin) {
        return ResponseEntity.ok(ApiResponse.success(adminService.approveApplication(id, admin)));
    }

    @PostMapping("/owner-applications/{id}/reject")
    @Operation(summary = "Reject owner application")
    public ResponseEntity<ApiResponse<com.luxeway.dto.ownerapplication.OwnerApplicationDTOs.OwnerApplicationResponse>> rejectApplication(
            @PathVariable String id,
            @Valid @RequestBody com.luxeway.dto.ownerapplication.OwnerApplicationDTOs.RejectApplicationRequest request,
            @AuthenticationPrincipal User admin) {
        return ResponseEntity.ok(ApiResponse.success(adminService.rejectApplication(id, request.getReason(), admin)));
    }
