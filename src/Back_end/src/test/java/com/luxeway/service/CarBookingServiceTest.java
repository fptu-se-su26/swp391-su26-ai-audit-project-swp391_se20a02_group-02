...
import com.luxeway.repository.CarAvailabilityRepository;
...
class CarBookingServiceTest {
    ...
    @Mock private CarAvailabilityRepository carAvailabilityRepository;
    ...
    void createBooking_ValidRequestWithAddons_CalculatesPricesCorrectly() {
        ...
        when(carBookingRepository.hasConflictingBooking("c1", req.getStartDate(), req.getEndDate()))
                .thenReturn(false);
        ...
        // Total = 3,000,000 + 450,000 + 200,000 + 1,500,000 + 1,500,000 + 360,000 + 240,000 - 300,000 = 6,950,000
        ...
        // Calendar blocked: 3 days
        verify(carAvailabilityRepository, times(3)).save(any(CarAvailability.class));
    }
    ...
    void createBooking_NotKycVerified_ThrowsException() {
        ...
        Exception ex = assertThrows(RuntimeException.class,
                () -> carBookingService.createBooking("r1", req));
        // Actual message from CarBookingService
    ...
    @Test
    void getBookingsByRenter_ReturnsOnlyRenterBookings() {
        Car car = Car.builder().id("c1").name("Car 1").build();
        CarBooking b1 = CarBooking.builder()
                .id("b1")
    ...
    void updateStatus_ValidTransition_UpdatesAndReturns() {
        Car car = Car.builder().id("c1").name("Car").build();
    ...
    void updateStatus_InvalidStatus_ThrowsException() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> carBookingService.updateStatus("b1", "NOT_A_STATUS"));
    }
