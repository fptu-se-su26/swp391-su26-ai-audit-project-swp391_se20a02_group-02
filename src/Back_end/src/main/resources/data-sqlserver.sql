...
('VM-01', 'E5F6G7H8-I9J0-1234-EFGH-567890123456', N'Honda Vision 2022 - Xe Đẹp Tiết Kiệm', N'Honda', N'Vision', 2022, 'SCOOTER', N'Xe Vision đời mới màu đỏ đô sạch sẽ, máy êm thích hợp lượn phố.', 'https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?w=800', 130000, 850000, 1000000, N'Hồ Chí Minh', N'Vietnam', N'Phú Nhuận, TP.HCM', 10.7994, 106.6803, 9, 95, 12.0, 2, 0, 'AUTOMATIC', 'GASOLINE', 250, '110cc', N'Đỏ', '59F1-99901', 1, 30, 365, 'AVAILABLE', 4.8, 12, 18, 1, 1, 1, 1, 20000, GETDATE(), GETDATE()),
('VM-02', 'E5F6G7H8-I9J0-1234-EFGH-567890123456', N'Honda Vision 2023 - Bản Cao Cấp', N'Honda', N'Vision', 2023, 'SCOOTER', N'Xe ga Honda Vision bản đặc biệt đen nhám cực ngầu, chạy đầm máy.', 'https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?w=800', 150000, 950000, 1000000, N'Hồ Chí Minh', N'Vietnam', N'Quận 1, TP.HCM', 10.7769, 106.7009, 9, 95, 12.0, 2, 0, 'AUTOMATIC', 'GASOLINE', 250, '110cc', N'Đen Nhám', '59F1-99902', 1, 30, 365, 'AVAILABLE', 4.9, 8, 15, 1, 1, 1, 1, 20000, GETDATE(), GETDATE()),
('VM-03', 'E5F6G7H8-I9J0-1234-EFGH-567890123456', N'Honda Vision 2021 - Đi Học Đi Làm', N'Honda', N'Vision', 2021, 'SCOOTER', N'Xe Vision trắng gia đình đi giữ gìn kỹ, xăng cộ cực tốt.', 'https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?w=800', 120000, 800000, 1000000, N'Hồ Chí Minh', N'Vietnam', N'Quận 3, TP.HCM', 10.7756, 106.6917, 9, 95, 12.0, 2, 0, 'AUTOMATIC', 'GASOLINE', 250, '110cc', N'Trắng', '59F1-99903', 1, 30, 365, 'AVAILABLE', 4.7, 20, 30, 1, 0, 1, 1, 20000, GETDATE(), GETDATE()),
('VM-04', 'F6G7H8I9-J0K1-2345-FGHI-678901234567', N'Honda Air Blade 125i - Đỏ Đen Thể Thao', N'Honda', N'Air Blade', 2022, 'AUTOMATIC_SCOOTER', N'Air Blade 125cc chạy êm, phanh cơ an toàn, có sạc điện thoại tiện lợi.', 'https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?w=800', 180000, 1100000, 1500000, N'Hà Nội', N'Vietnam', N'Cầu Giấy, Hà Nội', 21.0313, 105.7981, 11, 105, 10.5, 2, 0, 'AUTOMATIC', 'GASOLINE', 220, '125cc', N'Đỏ Đen', '29F1-99904', 1, 30, 365, 'AVAILABLE', 4.85, 15, 22, 1, 1, 1, 1, 30000, GETDATE(), GETDATE()),
('VM-05', 'F6G7H8I9-J0K1-2345-FGHI-678901234567', N'Honda Air Blade 160i - Phanh ABS Siêu Khỏe', N'Honda', N'Air Blade', 2023, 'AUTOMATIC_SCOOTER', N'Xe AB 160cc mạnh mẽ phanh ABS an toàn tuyệt đối, máy siêu bốc.', 'https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?w=800', 250000, 1500000, 2000000, N'Hà Nội', N'Vietnam', N'Hai Bà Trưng, Hà Nội', 21.0245, 105.8525, 15, 115, 8.5, 2, 0, 'AUTOMATIC', 'GASOLINE', 210, '160cc', N'Xanh Xám', '29F1-99905', 1, 30, 365, 'AVAILABLE', 4.95, 5, 12, 1, 1, 1, 1, 30000, GETDATE(), GETDATE()),
('VM-06', 'F6G7H8I9-J0K1-2345-FGHI-678901234567', N'Yamaha Exciter 155 VVA - Cam Đen Cực Chất', N'Yamaha', N'Exciter 155', 2022, 'MANUAL_MOTORCYCLE', N'Xe côn tay Exciter 155 VVA máy bốc, ga mượt, hoàn hảo cho phượt thủ.', 'https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?w=800', 200000, 1300000, 2000000, N'Đà Nẵng', N'Vietnam', N'Hải Châu, Đà Nẵng', 16.0678, 108.2208, 17, 125, 7.5, 2, 0, 'MANUAL', 'GASOLINE', 200, '155cc', N'Cam Đen', '43F1-99906', 1, 30, 365, 'AVAILABLE', 4.88, 18, 25, 1, 1, 1, 1, 25000, GETDATE(), GETDATE()),
('VM-07', 'F6G7H8I9-J0K1-2345-FGHI-678901234567', N'VinFast Evo200 - Xe Điện Thời Trang', N'VinFast', N'Evo200', 2023, 'ELECTRIC_BIKE', N'Evo200 đi êm ái thích hợp dạo biển phố Đà Nẵng, sạc đầy đi được 150km.', 'https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?w=800', 130000, 800000, 1500000, N'Đà Nẵng', N'Vietnam', N'Ngũ Hành Sơn, Đà Nẵng', 16.0583, 108.2608, 3, 70, 15.0, 2, 0, 'AUTOMATIC', 'ELECTRIC', 150, 'Electric', N'Vàng', '43F1-99907', 1, 30, 365, 'AVAILABLE', 4.76, 10, 14, 1, 0, 1, 1, 20000, GETDATE(), GETDATE()),
('VM-08', 'E5F6G7H8-I9J0-1234-EFGH-567890123456', N'Honda Lead 2022 - Cốp Siêu Rộng Rãi', N'Honda', N'Lead', 2022, 'SCOOTER', N'Xe Lead cốp rộng mênh mông đựng cả thế giới, thích hợp mua sắm du lịch.', 'https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?w=800', 160000, 1000000, 1500000, N'Hồ Chí Minh', N'Vietnam', N'Tân Bình, TP.HCM', 10.8014, 106.6525, 11, 100, 11.0, 2, 0, 'AUTOMATIC', 'GASOLINE', 230, '125cc', N'Đỏ Đô', '59F1-99908', 1, 30, 365, 'AVAILABLE', 4.82, 22, 28, 1, 1, 1, 1, 20000, GETDATE(), GETDATE()),
('VM-09', 'E5F6G7H8-I9J0-1234-EFGH-567890123456', N'Honda SH125i 2023 - Sang Chảnh Đẳng Cấp', N'Honda', N'SH125i', 2023, 'SCOOTER', N'SH 125i xám xi măng sang chảnh thời thượng, xe chạy cực kỳ êm ái.', 'https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?w=800', 350000, 2200000, 3000000, N'Hồ Chí Minh', N'Vietnam', N'Quận 7, TP.HCM', 10.7416, 106.7214, 12, 110, 10.0, 2, 0, 'AUTOMATIC', 'GASOLINE', 210, '125cc', N'Xám Xi Măng', '59F1-99909', 1, 30, 365, 'AVAILABLE', 4.96, 14, 20, 1, 1, 1, 1, 40000, GETDATE(), GETDATE()),
('VM-10', 'E5F6G7H8-I9J0-1234-EFGH-567890123456', N'Honda SH160i 2023 - ABS Cao Cấp', N'Honda', N'SH160i', 2023, 'SCOOTER', N'Honda SH160i ABS cực kỳ mạnh mẽ sang trọng, thu hút mọi ánh nhìn.', 'https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?w=800', 450000, 2800000, 4000000, N'Hồ Chí Minh', N'Vietnam', N'Quận 2, TP.HCM', 10.7872, 106.7490, 16, 120, 8.0, 2, 0, 'AUTOMATIC', 'GASOLINE', 200, '156cc', N'Trắng', '59F1-99910', 1, 30, 365, 'AVAILABLE', 4.98, 9, 14, 1, 1, 1, 1, 40000, GETDATE(), GETDATE()),
('VM-11', 'F6G7H8I9-J0K1-2345-FGHI-678901234567', N'Yamaha Sirius 2021 - Tiết Kiệm Bền Bỉ', N'Yamaha', N'Sirius', 2021, 'MANUAL_MOTORCYCLE', N'Sirius số tròn bền bỉ, thích hợp đi phượt ngắn dã ngoại giá cực rẻ.', 'https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?w=800', 100000, 600000, 1000000, N'Đà Nẵng', N'Vietnam', N'Liên Chiểu, Đà Nẵng', 16.0624, 108.1513, 8, 90, 13.0, 2, 0, 'MANUAL', 'GASOLINE', 260, '110cc', N'Đen Bạc', '43F1-99911', 1, 30, 365, 'AVAILABLE', 4.65, 34, 45, 1, 0, 1, 1, 20000, GETDATE(), GETDATE()),
('VM-12', 'F6G7H8I9-J0K1-2345-FGHI-678901234567', N'Yamaha Grande 2023 - Dành Cho Phái Đẹp', N'Yamaha', N'Grande', 2023, 'SCOOTER', N'Xe máy Grande trắng thời trang sang trọng, cốp to và máy cực kỳ êm.', 'https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?w=800', 180000, 1100000, 1500000, N'Hà Nội', N'Vietnam', N'Ba Đình, Hà Nội', 21.0361, 105.8275, 8, 95, 12.5, 2, 0, 'AUTOMATIC', 'GASOLINE', 250, '125cc', N'Trắng Ngọc Trai', '29F1-99912', 1, 30, 365, 'AVAILABLE', 4.88, 11, 16, 1, 1, 1, 1, 30000, GETDATE(), GETDATE()),
('VM-13', 'E5F6G7H8-I9J0-1234-EFGH-567890123456', N'VinFast Feliz S - Xe Máy Điện Tiện Lợi', N'VinFast', N'Feliz S', 2023, 'ELECTRIC_BIKE', N'Feliz S xe điện chất lượng cao của VinFast chạy êm ái, pin LFP cao cấp.', 'https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?w=800', 160000, 1000000, 1500000, N'Hồ Chí Minh', N'Vietnam', N'Gò Vấp, TP.HCM', 10.8388, 106.6669, 4, 80, 14.0, 2, 0, 'AUTOMATIC', 'ELECTRIC', 120, 'Electric', N'Xanh Dương', '59F1-99913', 1, 30, 365, 'AVAILABLE', 4.78, 7, 11, 1, 1, 1, 1, 20000, GETDATE(), GETDATE()),
('VM-14', 'E5F6G7H8-I9J0-1234-EFGH-567890123456', N'VinFast Klara S - Phong Cách Châu Âu', N'VinFast', N'Klara S', 2022, 'ELECTRIC_BIKE', N'Klara S mang đậm thiết kế Ý lịch lãm, đi mượt mà tiết kiệm.', 'https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?w=800', 180000, 1200000, 1500000, N'Hồ Chí Minh', N'Vietnam', N'Bình Thạnh, TP.HCM', 10.8030, 106.6974, 4, 80, 13.5, 2, 0, 'AUTOMATIC', 'ELECTRIC', 120, 'Electric', N'Trắng', '59F1-99914', 1, 30, 365, 'AVAILABLE', 4.85, 12, 19, 1, 1, 1, 1, 20000, GETDATE(), GETDATE()),
('VM-15', 'F6G7H8I9-J0K1-2345-FGHI-678901234567', N'Kawasaki Versys X300 - Phượt Tour Chuyên Nghiệp', N'Kawasaki', N'Versys X300', 2022, 'ADVENTURE_BIKE', N'Versys X300 dòng Adventure chuyên tour đi êm ái đầm chắc, thích hợp đi đèo.', 'https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?w=800', 650000, 4000000, 5000000, N'Hà Nội', N'Vietnam', N'Tây Hồ, Hà Nội', 21.0584, 105.8242, 40, 140, 6.0, 2, 0, 'MANUAL', 'GASOLINE', 350, '300cc', N'Xám Xanh', '29F1-99915', 1, 30, 365, 'AVAILABLE', 4.95, 21, 28, 1, 1, 1, 1, 50000, GETDATE(), GETDATE());
...
('MBI-1', 'BIKE-1', 'https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?q=80&w=800&auto=format&fit=crop', 1, 0),
('MBI-2', 'BIKE-2', 'https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?q=80&w=800&auto=format&fit=crop', 1, 0),
