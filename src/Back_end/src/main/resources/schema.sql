...
CREATE TABLE user_documents (
    ...
    document_type   NVARCHAR(30)    NOT NULL CONSTRAINT CHK_user_docs_type CHECK (document_type IN ('PASSPORT','NATIONAL_ID','DRIVING_LICENSE','INSURANCE','CCCD_FRONT','CCCD_BACK','DRIVER_LICENSE_FRONT','DRIVER_LICENSE_BACK','SELFIE_WITH_ID','INSURANCE_CERTIFICATE')),
