...
public class Motorbike {
    ...
    @OneToOne(mappedBy = "motorbike", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @ToString.Exclude
    @EqualsAndHashCode.Exclude
    private MotorbikeSpecification specification;

    @OneToOne(mappedBy = "motorbike", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @ToString.Exclude
    @EqualsAndHashCode.Exclude
    private MotorbikeLocation location;
