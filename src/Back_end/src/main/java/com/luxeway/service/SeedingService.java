...
public class SeedingService {
    ...
    public void seedAll() {
        ...
        // 3. Seed unified vehicles table — required for all public APIs (HomeService,
        // VehicleService)
        seedVehicles(owner);

        // 4. Fix any existing vehicles in DB that still have Unsplash/HTTP placeholder
        // images
    ...
    private void seedFeaturedVehicles(User owner) {
        ...
        if (!vehicleRepository.existsByLicensePlate("51K-999.99")) {
            Vehicle v = Vehicle.builder()
                    ...
                    .vehicleType(VehicleType.CAR)
                    .description(
                            "Toyota Camry 2.5Q đẳng cấp doanh nhân, nội thất da cao cấp, trang bị cửa sổ trời, hỗ trợ giao xe tận nơi nội thành TP.HCM.")
        ...
        if (!vehicleRepository.existsByLicensePlate("30K-888.88")) {
            Vehicle v = Vehicle.builder()
                    ...
                    .vehicleType(VehicleType.CAR)
                    .description(
                            "Hyundai Santa Fe 2024 SUV 7 chỗ thế hệ mới thiết kế vuông vức cơ bắp, động cơ dầu êm ái, thích hợp đi gia đình dã ngoại.")
        ...
        if (!vehicleRepository.existsByLicensePlate("43A-777.77")) {
            Vehicle v = Vehicle.builder()
                    ...
                    .vehicleType(VehicleType.CAR)
                    .description(
                            "VinFast VF8 Plus SUV điện thông minh, vận hành êm ái mạnh mẽ, hệ thống an toàn ADAS tân tiến, đầy đủ các tính năng trợ lý ảo thông minh.")
        ...
        if (!vehicleRepository.existsByLicensePlate("79A-666.66")) {
            Vehicle v = Vehicle.builder()
                    ...
                    .vehicleType(VehicleType.CAR)
                    .description(
                            "Mazda CX-5 Premium màu trắng ngọc trai cuốn hút, trang bị gói an toàn i-Activesense cao cấp nhất, loa Bose nghe nhạc cực chất.")
        ...
        if (!vehicleRepository.existsByLicensePlate("59-T1 999.99")) {
            Vehicle v = Vehicle.builder()
                    ...
                    .vehicleType(VehicleType.MOTORBIKE)
                    .description(
                            "Honda SH350i thời thượng, phân khối lớn mạnh mẽ, vận hành êm ái, xe mới đi giữ gìn sạch sẽ.")
        ...
        if (!vehicleRepository.existsByLicensePlate("29-H1 888.88")) {
            Vehicle v = Vehicle.builder()
                    ...
                    .vehicleType(VehicleType.MOTORBIKE)
                    .description(
                            "Yamaha Exciter 155 VVA côn tay thể thao, bốc, lướt êm, thích hợp cho các bạn trẻ đam mê xê dịch.")
        ...
        if (!vehicleRepository.existsByLicensePlate("43-D1 777.77")) {
            Vehicle v = Vehicle.builder()
                    ...
                    .vehicleType(VehicleType.MOTORBIKE)
                    .description(
                            "Honda Winner X côn tay thể thao năng động, phanh ABS an toàn, xe chạy cực bốc và tiết kiệm xăng.")
        ...
        if (!vehicleRepository.existsByLicensePlate("49-MD1 666.66")) {
            Vehicle v = Vehicle.builder()
                    ...
                    .vehicleType(VehicleType.MOTORBIKE)
                    .description(
                            "VinFast Klara S xe máy điện thời trang, di chuyển êm ái, yên tĩnh, thích hợp dạo quanh phố núi Đà Lạt mộng mơ.")
    ...
    private String getCarRealImage(String brand, String model) {
        ...
        if (b.contains("toyota")) {
            ...
            if (m.contains("fortuner"))
                return "/images/cars/toyota_forluner.jpg";
            if (m.contains("innova"))
                return "/images/cars/toyota_innova.jpg";
            if (m.contains("camry"))
                return "/images/cars/caramy_2.5Q.avif";
        }
        if (b.contains("mazda")) {
            if (m.contains("3"))
                return "/images/cars/Mazda_mazda3.jpg";
            if (m.contains("cx-5"))
                return "/images/cars/Mazda_cx5.jpg";
            if (m.contains("cx-8"))
                return "/images/cars/Madaz _CX8.jpg";
        }
        if (b.contains("mercedes")) {
            if (m.contains("c200"))
                return "/images/cars/mereedes_benz_c200.jpg";
            if (m.contains("e300"))
                return "/images/cars/Mereedes_benz_e300.jpg";
            if (m.contains("glc"))
                return "/images/cars/mereedes_benz_glc300.jpg";
        }
        if (b.contains("vinfast")) {
            if (m.contains("fadil"))
                return "/images/cars/vinfast_fadil.jpg";
            if (m.contains("vf8"))
                return "/images/cars/vinfast_v8.jpg";
            if (m.contains("vf9"))
                return "/images/cars/vinfast_v9.jpg";
        }
        if (b.contains("bmw")) {
            if (m.contains("320i"))
                return "/images/cars/BMW_320i.jpg";
            if (m.contains("520i"))
                return "/images/cars/BMW_520i.jpg";
            if (m.contains("x5"))
                return "/images/cars/BMW_X5.jpg";
        }
        if (b.contains("audi")) {
            if (m.contains("a4") || m.contains("q4"))
                return "/images/cars/audi_Q4.jpg";
            if (m.contains("q5"))
                return "/images/cars/audi_Q5.jpg";
        }
        if (b.contains("porsche")) {
            if (m.contains("macan"))
                return "/images/cars/porsche_macan.jpg";
            if (m.contains("cayenne"))
                return "/images/cars/porsche_cayenne.jpg";
        }
        if (b.contains("hyundai")) {
            if (m.contains("tucson"))
                return "/images/cars/hyundai_tuscon.jpg";
            if (m.contains("santa fe"))
                return "/images/cars/hyundai_santa_fe.jpg";
            if (m.contains("accent"))
                return "/images/cars/Hyundai-Aceent.jpg";
        }
        if (b.contains("honda")) {
            if (m.contains("city"))
                return "/images/cars/honda_city.jpg";
            if (m.contains("cr-v") || m.contains("crv"))
                return "/images/cars/Honda_CrV.jpg";
        }
        if (b.contains("kia")) {
            if (m.contains("morning"))
                return "/images/cars/kia_morning.jpg";
            if (m.contains("sorento"))
                return "/images/cars/kia_sorento.jpg";
            if (m.contains("carnival"))
                return "/images/cars/kia_carnival.jpg";
        }
        if (b.contains("ford")) {
            if (m.contains("ranger"))
                return "/images/cars/ford_ranger.jpg";
            if (m.contains("everest"))
                return "/images/cars/ford_everest.jpg";
        }
        if (b.contains("lexus")) {
            if (m.contains("es250") || m.contains("es"))
                return "/images/cars/Lexus_es250.jpg";
            if (m.contains("rx350") || m.contains("rx"))
                return "/images/cars/Lexus_Rx350.jpg";
        }
        if (b.contains("mitsubishi")) {
            if (m.contains("xpander"))
                return "/images/cars/Mitsibishi_xpannder.jpg";
            if (m.contains("outlander"))
                return "/images/cars/mitsubishi_outlander.jpg";
        }
        if (b.contains("nissan")) {
            if (m.contains("almera"))
                return "/images/cars/Nissan_Almera.jpg";
            if (m.contains("navara"))
                return "/images/cars/Nissan_navara.jpg";
        }
        return "/images/cars/toyota_vios.jpg";
    }
    ...
    private String getMotoRealImage(String brand, String model) {
        ...
        // Honda
        if (b.contains("honda")) {
            if (m.contains("sh 150") || m.contains("sh150"))
                return "/images/motorbikes/Honda_Sh_150i.jpg";
            if (m.contains("sh350") || m.contains("sh 350"))
                return "/images/motorbikes/Sh350_i.webp";
            if (m.contains("air blade") || m.contains("airblade"))
                return "/images/motorbikes/Honda_air_blade.jpg";
            if (m.contains("vision"))
                return "/images/motorbikes/Honda_vision.jpg";
            if (m.contains("winner"))
                return "/images/motorbikes/Honda_winer_X.jpg";
        }
        // Yamaha
        if (b.contains("yamaha")) {
            if (m.contains("exciter") || m.contains("eceiter"))
                return "/images/motorbikes/Yamaha_eceiter_155.jpg";
            if (m.contains("grande"))
                return "/images/motorbikes/Yamaha_Grande.jpg";
            if (m.contains("nvx"))
                return "/images/motorbikes/Yamaha_NVX_155.webp";
            if (m.contains("sirius"))
                return "/images/motorbikes/Yamaha_sirius.jpg";
        }
        // Kawasaki
        if (b.contains("kawasaki")) {
            if (m.contains("ninja"))
                return "/images/motorbikes/Kawaski_ninja_400.jpg";
            if (m.contains("z400") || m.contains("z 400"))
                return "/images/motorbikes/Kawasaki_Z400.jpg";
        }
        // KTM
        if (b.contains("ktm")) {
            if (m.contains("duke"))
                return "/images/motorbikes/KTM_Duke_390.jpg";
            if (m.contains("adventure"))
                return "/images/motorbikes/KTM_adventure_390.jpg";
        }
        // BMW Motorrad
        if (b.contains("bmw")) {
        ...
        if (b.contains("royal enfield") || b.contains("royal_enfield")) {
            if (m.contains("himalayan"))
                return "/images/motorbikes/Royal_Enfield_himalayan.jpg";
        ...
        try {
            ...
            for (Vehicle v : vehicles) {
                ...
                if (isMockUrl) {
                    ...
                    vehicleRepository.save(v);
                    count++;
                    log.info("Fixed image for {} {} {} -> {}", v.getVehicleType(), v.getBrand(), v.getModel(),
                            realImage);
                }
            }
            if (count > 0) {
                ...
                if (c.getImages() != null) {
                    for (CarImage img : c.getImages()) {
                        ...
                        if (url != null && (url.contains("unsplash.com") || url.startsWith("http"))) {
                            String realImage = getCarRealImage(c.getModel().getBrand().getName(),
                                    c.getModel().getName());
    ...
    private User getOrCreatePendingKycCustomer() {
        return userRepository.findByEmail("demo.pending.kyc@luxeway.vn")
    ...
    private Booking ensureDemoCompletedBooking(User customer, User owner, Vehicle vehicle) {
        return bookingRepository.findByBookingCode("LXW-DEMO-COMPLETED")
    ...
    private UserDocument ensurePendingKycDocument(User user) {
        ...
        for (UserDocument doc : docs) {
            if ("PENDING".equalsIgnoreCase(doc.getStatus())
                    || "UNDER_REVIEW".equalsIgnoreCase(doc.getVerificationStatus())) {
                return doc;
            }
        }
    ...
    private void seedCars(User owner) {
        ...
        carBrandsMap.put("Toyota", new String[] { "Japan", "Vios:Sedan:500000:800000:5",
                "Camry:Sedan:1200000:1800000:5", "Fortuner:SUV:1200000:1800000:7", "Innova:MPV:800000:1200000:7" });
        carBrandsMap.put("Mazda", new String[] { "Japan", "Mazda 3:Sedan:700000:900000:5",
                "Mazda 6:Sedan:1100000:1400000:5", "CX-5:SUV:1000000:1300000:5", "CX-8:SUV:1300000:1700000:7" });
        carBrandsMap.put("Mercedes-Benz", new String[] { "Germany", "C200:Luxury:2200000:2800000:5",
                "E300:Luxury:3500000:4500000:5", "S450:Luxury:6000000:9000000:5", "GLC300:Luxury:3000000:4000000:5" });
        carBrandsMap.put("VinFast",
                new String[] { "Vietnam", "Fadil:Economy:450000:600000:5", "Lux A2.0:Sedan:900000:1200000:5",
                        "VF8:Electric:1500000:2000000:5", "VF9:Electric:2200000:3000000:7" });
        carBrandsMap.put("Porsche", new String[] { "Germany", "Macan:Luxury:4500000:6000000:5",
                "Cayenne:Luxury:6000000:8500000:5", "Panamera:Luxury:7000000:9500000:5" });
        carBrandsMap.put("BMW", new String[] { "Germany", "320i:Sedan:1800000:2400000:5",
                "520i:Sedan:2500000:3200000:5", "X5:SUV:3500000:4500000:7" });
        carBrandsMap.put("Audi", new String[] { "Germany", "A4:Sedan:1800000:2300000:5", "Q5:SUV:2500000:3200000:5",
                "Q7:SUV:3500000:4500000:7" });
        carBrandsMap.put("Lexus", new String[] { "Japan", "ES250:Luxury:2500000:3200000:5",
                "RX350:Luxury:4000000:5500000:5", "LX570:Luxury:8000000:11000000:7" });
        carBrandsMap.put("Hyundai", new String[] { "South Korea", "Accent:Sedan:500000:700000:5",
                "Elantra:Sedan:700000:900000:5", "Tucson:SUV:900000:1200000:5", "SantaFe:SUV:1200000:1700000:7" });
        carBrandsMap.put("Honda", new String[] { "Japan", "City:Sedan:500000:700000:5", "Civic:Sedan:800000:1100000:5",
                "CR-V:SUV:1100000:1500000:7" });
        carBrandsMap.put("Kia", new String[] { "South Korea", "Morning:Economy:400000:550000:5",
                "Cerato:Sedan:600000:800000:5", "Sorento:SUV:1100000:1500000:7", "Carnival:MPV:1800000:2500000:7" });
        carBrandsMap.put("Mitsubishi",
                new String[] { "Japan", "Xpander:MPV:700000:950000:7", "Outlander:SUV:1000000:1300000:7" });
        carBrandsMap.put("Ford",
                new String[] { "USA", "Ranger:Pickup:900000:1300000:5", "Everest:SUV:1200000:1800000:7" });
        carBrandsMap.put("Nissan",
                new String[] { "Japan", "Almera:Sedan:500000:700000:5", "Navara:Pickup:850000:1200000:5" });
        carBrandsMap.put("Suzuki",
                new String[] { "Japan", "Swift:Economy:500000:700000:5", "XL7:MPV:700000:950000:7" });
        carBrandsMap.put("Peugeot", new String[] { "France", "2008:SUV:800000:1100000:5", "3008:SUV:1100000:1400000:5",
                "5008:SUV:1400000:1900000:7" });
        carBrandsMap.put("Subaru", new String[] { "Japan", "Forester:SUV:1100000:1500000:5" });
        carBrandsMap.put("Volvo",
                new String[] { "Sweden", "XC60:Luxury:2800000:3600000:5", "XC90:Luxury:4500000:6000000:7" });
        carBrandsMap.put("Chevrolet",
                new String[] { "USA", "Cruze:Sedan:500000:700000:5", "Colorado:Pickup:800000:1100000:5" });
            ...
            for (Map.Entry<String, String[]> entry : carBrandsMap.entrySet()) {
                ...
                for (int i = 1; i < brandData.length; i++) {
                    ...
                    CarSpecification spec = CarSpecification.builder()
                            ...
                            .fuelType(category.equalsIgnoreCase("Electric") ? FuelType.ELECTRIC
                                    : (carIndex % 3 == 0 ? FuelType.DIESEL : FuelType.GASOLINE))
    ...
    private void seedMotorbikes(User owner) {
        // Brand, Country, Models (Name, Category, priceRangeMin, priceRangeMax,
        // engineCc)
        Map<String, String[]> motorbikeBrandsMap = new LinkedHashMap<>();
        motorbikeBrandsMap.put("Honda",
                new String[] { "Japan", "Vision:Scooter:120000:150000:110", "Air Blade:Scooter:150000:200000:125",
                        "SH 150i:Scooter:350000:500000:150", "Winner X:Manual_Motorcycle:150000:180000:150" });
        motorbikeBrandsMap.put("Yamaha",
                new String[] { "Japan", "Sirius:Manual_Motorcycle:100000:130000:110",
                        "Exciter 155:Manual_Motorcycle:160000:200000:155", "Grande:Scooter:150000:180000:125",
                        "NVX 155:Scooter:180000:220000:155" });
        motorbikeBrandsMap.put("Vespa", new String[] { "Italy", "Sprint:Scooter:300000:400000:125",
                "Primavera:Scooter:280000:350000:125", "GTS 300:Scooter:600000:800000:300" });
        motorbikeBrandsMap.put("Ducati", new String[] { "Italy", "Monster 797:Sport_Bike:1200000:1600000:803",
                "Scrambler:Classic_Bike:1500000:2000000:803" });
        motorbikeBrandsMap.put("Triumph", new String[] { "UK", "Trident 660:Classic_Bike:1200000:1500000:660",
                "Bonneville T120:Classic_Bike:1800000:2400000:1200" });
        motorbikeBrandsMap.put("Suzuki", new String[] { "Japan", "Raider R150:Manual_Motorcycle:150000:180000:150",
                "Satria F150:Manual_Motorcycle:160000:190000:150" });
        motorbikeBrandsMap.put("Kawasaki", new String[] { "Japan", "Ninja 400:Sport_Bike:800000:110000:399",
                "Z400:Sport_Bike:750000:100000:399" });
        motorbikeBrandsMap.put("BMW Motorrad", new String[] { "Germany", "G310GS:Adventure_Bike:900000:1200000:313",
                "R1250GS:Adventure_Bike:2200000:3000000:1254" });
        motorbikeBrandsMap.put("KTM", new String[] { "Austria", "Duke 390:Sport_Bike:800000:1100000:373",
                "Adventure 390:Adventure_Bike:900000:1200000:373" });
        motorbikeBrandsMap.put("SYM", new String[] { "Taiwan", "Attila:Scooter:110000:140000:125",
                "Galaxy:Manual_Motorcycle:100000:120000:110" });
        motorbikeBrandsMap.put("Harley-Davidson", new String[] { "USA", "Iron 883:Classic_Bike:1600000:2200000:883" });
        motorbikeBrandsMap.put("Royal Enfield", new String[] { "India", "Classic 350:Classic_Bike:700000:900000:349",
                "Himalayan:Adventure_Bike:800000:1000000:411" });
            ...
            for (Map.Entry<String, String[]> entry : motorbikeBrandsMap.entrySet()) {
                ...
                MotorbikeBrand brand = motorbikeBrandRepository.findByName(brandName).orElseGet(() -> {
                    MotorbikeBrand newBrand = MotorbikeBrand.builder()
                            ...
                            .country(country)
                            .logoUrl(
                                    "https://images.unsplash.com/photo-1558981806-ec527fa84c39?q=80&w=200&auto=format&fit=crop")
                            .isActive(true)
                            .createdAt(LocalDateTime.now())
                            .build();
                ...
                for (int i = 1; i < brandData.length; i++) {
                    ...
                    MotorbikeSpecification spec = MotorbikeSpecification.builder()
                            ...
                            .engineCc(engineCc)
                            .transmission(
                                    category.contains("Scooter") ? TransmissionType.AUTOMATIC : TransmissionType.MANUAL)
                            .helmetIncluded(true)
    ...
    private BigDecimal getRealLatitude(String city, int idx) {
        ...
        // Add pseudo-random deterministic jitter to spread vehicles out naturally (50m
        // to 300m range)
