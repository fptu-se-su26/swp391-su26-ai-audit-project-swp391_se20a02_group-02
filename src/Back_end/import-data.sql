...
DELETE FROM destination_analytics;
DELETE FROM faqs;
DELETE FROM users;
...
('E5F6G7H8-I9J0-1234-EFGH-567890123456', 'pham.minh.d@gmail.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', N'Phạm', N'Minh D', N'Phạm Minh D', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200&h=200&fit=crop', '0904444444', 'OWNER', 1, 1, 1, 4.95, 45, 0, N'Chủ sở hữu đội xe gia đình chạy dịch vụ, cam kết chất lượng tốt nhất', N'Hồ Chí Minh', 'INDIVIDUAL', NULL, NULL, 1, '2024-01-20 09:15:00', '2024-05-23 07:20:00', '2024-01-20 09:15:00', '2024-05-23 07:20:00'),
('D4E5F6G7-H8I9-0123-CDFG-456789012345', 'business@luxeway.vn', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', N'Doanh Nghiệp', N'LuxeWay', N'LuxeWay Enterprise', 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=200&h=200&fit=crop', '0909999999', 'OWNER', 1, 1, 1, 5.00, 0, 0, N'LuxeWay Enterprise - Đơn vị cung cấp dịch vụ thuê xe sang trọng hàng đầu Việt Nam', N'Hà Nội', 'BUSINESS', N'LuxeWay Enterprise', NULL, 1, '2024-01-01 00:00:00', '2024-05-23 10:00:00', '2024-01-01 00:00:00', '2024-05-23 10:00:00');
