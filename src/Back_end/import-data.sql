...
('V1A2B3C4-D5E6-7890-VHCL-111111111111', 'E5F6G7H8-I9J0-1234-EFGH-567890123456', 'Honda City 2023 - Xe Đẹp Như Mới', 'Honda', 'City', 2023, 'ECONOMY', 'Honda City 2023 màu trắng, nội thất đen sang trọng. Xe được bảo dưỡng định kỳ, sạch sẽ, tiết kiệm nhiên liệu.', 'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=800&auto=format&fit=crop', 800000.00, 5200000.00, 3000000.00, 'Hà Nội', 'Vietnam', '123 Đường Láng, Đống Đa, Hà Nội', 21.0285, 105.8542, 120, 180, 11.5, 5, 4, 'AUTOMATIC', 'GASOLINE', 600, '1.5L', 'Trắng', '30A-12345', 1, 15, 365, 'AVAILABLE', 4.80, 25, 18, 1, 0, 1, 1, 50000.00, '2024-02-01 10:00:00', '2024-05-23 08:00:00'),
('V2B3C4D5-E6F7-8901-VHCL-222222222222', 'E5F6G7H8-I9J0-1234-EFGH-567890123456', 'Toyota Vios 2022 - Tiết Kiệm Nhiên Liệu', 'Toyota', 'Vios', 2022, 'ECONOMY', 'Toyota Vios 2022 màu bạc, số tự động, máy lạnh mát, âm thanh tốt.', 'https://images.unsplash.com/photo-1590362891991-f776e747a588?w=800&auto=format&fit=crop', 750000.00, 4900000.00, 2800000.00, 'Hà Nội', 'Vietnam', '456 Phố Huế, Hai Bà Trưng, Hà Nội', 21.0245, 105.8525, 107, 175, 12.3, 5, 4, 'AUTOMATIC', 'GASOLINE', 650, '1.5L', 'Bạc', '30B-67890', 1, 20, 365, 'AVAILABLE', 4.90, 31, 22, 1, 1, 1, 1, 50000.00, '2024-02-15 14:30:00', '2024-05-22 19:45:00');
...
PRINT 'Total Vehicles: ' + CAST((SELECT COUNT(*) FROM vehicles) AS VARCHAR(10));
PRINT '';
PRINT 'Test Accounts:';
