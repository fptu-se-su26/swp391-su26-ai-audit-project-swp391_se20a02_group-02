    ...
    <div className="space-y-8 animate-fade-in font-sans">
        ...
        {[
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <span className={`text-[8px] font-black tracking-widest px-2.5 py-1 rounded-xl uppercase ${isDark ? 'bg-slate-800 text-slate-400' : 'bg-slate-50 dark:bg-slate-950 text-slate-500'}`}>
                LIVE
              </span>
            </div>
            <p className={`text-2xl font-black mb-1.5 tracking-tight ${stat.color.includes('emerald') ? 'text-emerald-500' : isDark ? 'text-white' : 'text-slate-900 dark:text-slate-100'}`}>
              {stat.value}
            </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className={`lg:col-span-2 border rounded-[2.5rem] p-6 shadow-2xl ${
          isDark ? 'bg-slate-900/60 border-slate-800/80 shadow-slate-950/40' : 'bg-white dark:bg-slate-900/70 border-slate-200 dark:border-slate-700/60 shadow-slate-200/30'
        }`}>
            ...
            {activeFleetTracking.map(item => (
              <div 
                ...
                className={`flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 border rounded-2xl transition-all duration-300 hover:scale-[1.01] ${
                  isDark ? 'bg-slate-950/30 border-slate-850' : 'bg-slate-50 dark:bg-slate-950/50 border-slate-150'
                }`}
              >
            ...
            <div className="space-y-3">
              {corporateReports.map(report => (
                <div key={report.name} className={`p-3.5 border rounded-xl flex items-center justify-between ${
                  isDark ? 'bg-slate-950/30 border-slate-850' : 'bg-slate-50 dark:bg-slate-950 border-slate-150'
                }`}>
...
export const FleetManagementPage: React.FC = () => (
  <div className="space-y-6 animate-fade-in font-sans">
    ...
    <div className="glass border border-slate-200 dark:border-slate-700/50 dark:border-white/5 p-6 rounded-[2rem] text-center text-slate-400">
      <Car className="w-12 h-12 text-slate-300 dark:text-slate-700 dark:text-slate-300 mx-auto mb-3" />
...
export const EmployeeManagementPage: React.FC = () => (
  <div className="space-y-6 animate-fade-in font-sans">
    ...
    <div className="glass border border-slate-200 dark:border-slate-700/50 dark:border-white/5 p-6 rounded-[2rem] text-center text-slate-400">
      <Users className="w-12 h-12 text-slate-300 dark:text-slate-700 dark:text-slate-300 mx-auto mb-3" />
...
export const DriverManagementPage: React.FC = () => (
  <div className="space-y-6 animate-fade-in font-sans">
    ...
    <div className="glass border border-slate-200 dark:border-slate-700/50 dark:border-white/5 p-6 rounded-[2rem] text-center text-slate-400">
      <Briefcase className="w-12 h-12 text-slate-300 dark:text-slate-700 dark:text-slate-300 mx-auto mb-3" />
...
export const FleetAnalyticsPage: React.FC = () => (
  <div className="space-y-6 animate-fade-in font-sans">
    ...
    <div className="glass border border-slate-200 dark:border-slate-700/50 dark:border-white/5 p-6 rounded-[2rem] text-center text-slate-400">
      <BarChart3 className="w-12 h-12 text-slate-300 dark:text-slate-700 dark:text-slate-300 mx-auto mb-3" />
...
export const CorporateReportsPage: React.FC = () => (
  <div className="space-y-6 animate-fade-in font-sans">
    ...
    <div className="glass border border-slate-200 dark:border-slate-700/50 dark:border-white/5 p-6 rounded-[2rem] text-center text-slate-400">
      <FileText className="w-12 h-12 text-slate-300 dark:text-slate-700 dark:text-slate-300 mx-auto mb-3" />
                    ...
                    className={`w-full flex items-center gap-3 px-4.5 py-3.5 rounded-2xl text-[10px] font-black uppercase tracking-widest whitespace-nowrap transition-all duration-300 relative group ${
                      active 
                        ...
                        : isDark 
                          ...
                          : 'text-slate-655 hover:text-slate-900 dark:text-slate-100 hover:bg-slate-100 dark:bg-slate-800/50'
                    }`}
                  >
