  ...
  <section className="py-24 bg-slate-50 dark:bg-slate-900">
    <div className="max-w-7xl mx-auto px-6">
      <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-14">
        ...
        <h2 className="font-bold text-3xl md:text-5xl text-[#0F172A] dark:text-white mb-4">How LuxeWay Works</h2>
      ...
      >
        {STEPS.map((step, i) => (
          <motion.div
            ...
            className="relative bg-white dark:bg-slate-900 rounded-3xl p-10 shadow-sm border border-slate-100 dark:border-slate-800 text-center group hover:shadow-lg transition-shadow"
          >
            ...
            <h3 className="font-extrabold text-[#0F172A] dark:text-white text-lg md:text-xl mb-3">{step.title}</h3>
