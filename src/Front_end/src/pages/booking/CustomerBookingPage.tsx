...
export const CustomerBookingPage: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className={`min-h-screen pt-20 flex flex-col items-center justify-center ${isDark ? 'bg-slate-900 text-white' : 'bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100'}`}>
  ...
  if (!bookingInfo) {
    return (
      <div className={`min-h-screen pt-20 flex flex-col items-center justify-center p-4 ${isDark ? 'bg-slate-900 text-white' : 'bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100'}`}>
  ...
  return (
    <div className={`min-h-screen pt-16 flex flex-col ${isDark ? 'bg-slate-950 text-white' : 'bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100'}`}>
      ...
      <div className="p-4 flex items-center justify-between border-b border-white/5 bg-slate-900/60 backdrop-blur-md relative z-20">
        <div className="flex items-center gap-3">
          <Link to="/dashboard/bookings" className="p-2.5 rounded-xl hover:bg-white dark:bg-slate-900/10 text-white transition-colors">
