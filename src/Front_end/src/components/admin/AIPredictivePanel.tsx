...
const glassCard = (isDark: boolean) =>
  cn(
    ...
    isDark ? 'bg-slate-900/60 border-slate-700/40' : 'bg-white dark:bg-slate-900/80 border-slate-200 dark:border-slate-700'
  );
          ...
          {onRefresh && (
            <button
              ...
              className={cn(
                ...
                isDark ? 'bg-slate-800 border-slate-700 text-slate-300 hover:bg-slate-700' : 'bg-slate-50 dark:bg-slate-950 border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:bg-slate-800'
              )}
            >
                  ...
                  <span
                    ...
                    className={cn(
                      ...
                      isPeak
                        ...
                        : isDark ? 'bg-slate-800 text-slate-400 border-slate-700' : 'bg-slate-50 dark:bg-slate-950 text-slate-500 border-slate-200 dark:border-slate-700'
                    )}
                  >
            ...
            {churnRisks.slice(0, 50).map((c, i) => (
              <div
                ...
                className={cn(
                  ...
                  isDark ? 'bg-slate-800/40 border-slate-700/30' : 'bg-slate-50 dark:bg-slate-950 border-slate-200 dark:border-slate-700/60'
                )}
              >
                ...
                <motion.div
                  ...
                  className={cn(
                    ...
                    isCritical
                      ...
                      : isDark ? 'bg-slate-800/40 border-slate-700/30' : 'bg-slate-50 dark:bg-slate-950 border-slate-200 dark:border-slate-700'
                  )}
                >
