  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-3 right-3 p-1 rounded-lg text-slate-400 hover:text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:bg-slate-800 transition-colors"
      >
