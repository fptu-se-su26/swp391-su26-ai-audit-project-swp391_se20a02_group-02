    ...
    <motion.button
      ...
      className={cn(
        ...
        isDark
          ...
          : 'text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:text-slate-50'
      )}
    >
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex items-center gap-1.5 p-2.5 rounded-xl text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 dark:text-slate-400 dark:hover:bg-slate-700 hover:text-slate-900 dark:text-slate-50 transition-colors duration-200"
              ...
              <button
                ...
                className={cn(
                  ...
                  language === lang.code
                    ...
                    : 'text-slate-600 hover:bg-slate-50 dark:hover:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700'
                )}
              >
...
export const Navbar: React.FC = () => {
  ...
  const hoverBg = isDark ? 'hover:bg-slate-700 hover:text-white' : 'hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:text-slate-50';
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isDark
                          ...
                          : 'border-slate-200 dark:border-slate-700 hover:border-slate-300 hover:shadow-sm bg-white dark:bg-slate-900'
                      )}
                    >
                      {user.avatar ? (
                      ...
                      {userMenuOpen && (
                        <motion.div
                          ...
                          className={cn(
                            ...
                            isDark ? 'bg-slate-800 border-slate-700' : 'bg-white dark:bg-slate-900 border-slate-100 dark:border-slate-800'
                          )}
                        >
                          {/* User Info */}
                          <div className={cn('p-4 border-b', isDark ? 'bg-slate-700/50 border-slate-600' : 'bg-gradient-to-br from-slate-50 to-slate-100 border-slate-100 dark:border-slate-800')}>
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <p className={cn('font-semibold text-sm', isDark ? 'text-white' : 'text-[#0F172A] dark:text-white')}>{user.displayName}</p>
                              ...
                              return menuItems.map(item => (
                                <Link
                                  ...
                                  className={cn(
                                    ...
                                    isDark ? 'text-slate-300 hover:bg-slate-700 hover:text-white' : 'text-slate-600 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900 dark:text-slate-50'
                                  )}
                                >
                          ...
                          <div className={cn('border-t p-2', isDark ? 'border-slate-700' : 'border-slate-100 dark:border-slate-800')}>
                            <button
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div
              ...
              transition={{ duration: 0.25 }}
              className={cn('lg:hidden border-t overflow-hidden', isDark ? 'border-slate-700 bg-slate-900' : 'border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900')}
            >
                ...
                {navLinks.map(link => (
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive(link.href)
                        ? 'bg-[#0F172A] text-white'
                        : isDark ? 'text-slate-300 hover:bg-slate-800' : 'text-slate-600 hover:bg-slate-100 dark:hover:bg-slate-800'
                    )}
                  >
                    {link.label}
                  </Link>
